...
namespace XamarinHmsPushDemo
{
    ...
    public class MainActivity : AppCompatActivity, View.IOnClickListener
    {
        ...
        private static readonly string CODELABS_ACTION = "com.companyname.hms_map_demo.action";
     ...
     */
        ...
        private void GenerateIntentUri()
        {
            ...
            intent.SetData(Uri.Parse("pushscheme://com.companyname.hms_map_demo/deeplink?name=abc&age=180"));
